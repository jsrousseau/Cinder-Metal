...
- (void) drawInMTKView:(nonnull MTKView *)view
{
    ...
    if(renderPassDescriptor != nil)
    {
        ...
        // on an iPhone8 this would lead to a 30 fps rate
        // [commandBuffer presentDrawable:view.currentDrawable afterMinimumDuration:0.02];
        
        // this would make sure we hit 60 fps
