...
static const AAPLSimulationConfig AAPLSimulationConfigTable[] =
{
    ...
    {      1.0,    1.000,    16384,        1.54,            5,      100.0,        16384,    0.0166,        5.0 },
    {      1.0,    1.000,    16384,        0.32,          276,        2.5,        65536,    0.0006,        0.3 },
    {      1.0,    0.100,    16384,        0.68,           20,     1700.0,        8192,     0.0166,        5.0 },
    {      1.0,    1.000,    16384,        1.54,            8,       25.0,        8192,     0.0166,        5.0 },
    {      1.0,    1.000,    16384,        6.04,            0,      300.0,        8192,     0.0166,        5.0 },
    {      1.0,    0.145,    16384,        0.32,          272,        2.5,        8192,     0.0006,        0.3 },
};
